                        ...
                        <div class="settings-sidebar">
                            <div class="sidebar-header">
                                <h2 class="sidebar-title">
                                    {{
                                        mode === "create"
                                            ? $t("agent.editor.createTitle")
                                            : $t("agent.editor.editTitle")
                                    }}
                                </h2>
                            </div>
                            ...
                            <div class="content-wrapper">
                                    ...
                                    <div class="settings-group">
                                                ...
                                                <p class="desc">
                                                    {{
                                                        agentMode === "smart-reasoning"
                                                            ? $t("agent.editor.agentDesc")
                                                            : $t("agent.editor.normalDesc")
                                                    }}
                                                </p>
                                            </div>
                                        ...
                                        <div class="setting-row">
                                            <div class="setting-info">
                                                <label
                                                    >{{ $t("agent.editor.name") }}
                                                    <span v-if="!isBuiltinAgent" class="required"
                                                        >*</span
                                                    ></label
                                                >
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.name") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <div class="name-input-wrapper">
                                                    ...
                                                    <div
                                                        ...
                                                        :class="isAgentMode ? 'agent' : 'normal'">
                                                        <t-icon
                                                            :name="
                                                                isAgentMode
                                                                    ? 'control-platform'
                                                    ...
                                                    <t-input
                                                        ...
                                                        :placeholder="
                                                            $t('agent.editor.namePlaceholder')
                                                        "
                                                        class="name-input"
                                                        :disabled="isBuiltinAgent" />
                                                </div>
                                        ...
                                        <div class="setting-row">
                                            <div class="setting-info">
                                                ...
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.description") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-textarea
                                                    ...
                                                    :placeholder="
                                                        $t('agent.editor.descriptionPlaceholder')
                                                    "
                                        ...
                                        <div class="setting-row setting-row-vertical">
                                            <div class="setting-info">
                                                <label
                                                    >{{ $t("agent.editor.systemPrompt") }}
                                                    <span v-if="!isBuiltinAgent" class="required"
                                                        >*</span
                                                    ></label
                                                >
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.systemPrompt")
                                                    }}{{
                                                        isBuiltinAgent
                                                            ? $t(
                                                                  "agentEditor.desc.leaveEmptyDefault",
                                                              )
                                                            : ""
                                                    }}
                                                </p>
                                                <div class="placeholder-tags">
                                                    <span class="placeholder-label">{{
                                                        $t("agentEditor.placeholders.available")
                                                    }}</span>
                                                    <t-tooltip
                                                        ...
                                                        :content="
                                                            ...
                                                            $t(
                                                                'agentEditor.placeholders.clickToInsert',
                                                            )
                                                        "
                                                        placement="top">
                                                        <span
                                                    ...
                                                    <span class="placeholder-hint">{{
                                                        $t("agentEditor.placeholders.hint")
                                                    }}</span>
                                                </div>
                                            </div>
                                            <div
                                                class="setting-control setting-control-full"
                                                style="position: relative">
                                                <!-- Agent模式：统一提示词（使用 {{web_search_status}} 占位符动态控制行为） -->
                                                <div
                                                    v-if="isAgentMode"
                                                    class="textarea-with-template">
                                                    <t-textarea
                                                    ...
                                                    <PromptTemplateSelector
                                                        ...
                                                        @reset-default="
                                                            handleSystemPromptTemplateSelect
                                                        " />
                                                </div>
                                                <!-- 普通模式：单个提示词 -->
                                        ...
                                        <div
                                            ...
                                            <div class="setting-info">
                                                <label
                                                    >{{ $t("agent.editor.contextTemplate") }}
                                                    <span v-if="!isBuiltinAgent" class="required"
                                                        >*</span
                                                    ></label
                                                >
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.contextTemplate")
                                                    }}{{
                                                        isBuiltinAgent
                                                            ? $t(
                                                                  "agentEditor.desc.leaveEmptyDefault",
                                            ...
                                            <div
                                                ...
                                                <Teleport to="body">
                                                    <div
                                                        v-if="
                                                            showContextPlaceholderPopup &&
                                                            filteredContextPlaceholders.length > 0
                                                        "
                                                        class="placeholder-popup-wrapper"
                                                        ...
                                                        <div class="placeholder-popup">
                                                            <div
                                                                v-for="(
                                                                    placeholder, index
                                                                ) in filteredContextPlaceholders"
                                                                :key="placeholder.name"
                                                                class="placeholder-item"
                                                                :class="{
                                                                    active:
                                                                        selectedContextPlaceholderIndex ===
                                                                        index,
                                                                }"
                                                                @mousedown.prevent="
                                                                    insertContextPlaceholder(
                                                                        placeholder.name,
                                                                        true,
                                                                    )
                                                                "
                                ...
                                <div v-show="currentSection === 'model'" class="section">
                                    <div class="section-header">
                                        ...
                                        <p class="section-description">
                                            {{ $t("agent.editor.modelConfigDesc") }}
                                        </p>
                                    </div>
                                    ...
                                    <div class="settings-group">
                                        ...
                                        <div class="setting-row">
                                            <div class="setting-info">
                                                <label
                                                    >{{ $t("agent.editor.model") }}
                                                    <span class="required">*</span></label
                                                >
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.model") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <ModelSelector
                                                    ...
                                                    @update:selected-model-id="
                                                        (val: string) =>
                                                            (formData.config.model_id = val)
                                                    "
                                                    @add-model="handleAddModel('llm')"
                                                    :placeholder="
                                                        $t('agent.editor.modelPlaceholder')
                                                    " />
                                            </div>
                                        </div>
                                        ...
                                        <div class="setting-row">
                                            <div class="setting-info">
                                                ...
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.temperature") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                        ...
                                        <div v-if="!isAgentMode" class="setting-row">
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agent.editor.maxCompletionTokens")
                                                }}</label>
                                                <p class="desc">
                                ...
                                <div v-show="currentSection === 'multimodal'" class="section">
                                    <div class="section-header">
                                        ...
                                        <p class="section-description">
                                            {{ $t("agentEditor.imageUpload.sectionDesc") }}
                                        </p>
                                    </div>
                                    ...
                                    <div class="settings-group">
                                        ...
                                        <div class="setting-row">
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agentEditor.imageUpload.label")
                                                }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.imageUpload.desc") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-switch
                                                    v-model="
                                                        formData.config.image_upload_enabled
                                                    " />
                                            </div>
                                        </div>
                                        ...
                                        <!-- VLM模型（图片上传启用时） -->
                                        <div
                                            v-if="formData.config.image_upload_enabled"
                                            class="setting-row">
                                            <div class="setting-info">
                                                <label
                                                    >{{ $t("agentEditor.imageUpload.vlmModel") }}
                                                    <span class="required">*</span></label
                                                >
                                                <p class="desc">
                                                    {{ $t("agentEditor.imageUpload.vlmModelDesc") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <ModelSelector
                                                    model-type="VLLM"
                                                    :selected-model-id="
                                                        formData.config.vlm_model_id
                                                    "
                                                    :all-models="allModels"
                                                    @update:selected-model-id="
                                                        (val: string) =>
                                                            (formData.config.vlm_model_id = val)
                                                    "
                                                    @add-model="handleAddModel('vllm')"
                                                    :placeholder="
                                                        $t(
                                                            'agentEditor.imageUpload.vlmModelPlaceholder',
                                                        )
                                                    " />
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agentEditor.imageUpload.storageProvider")
                                                }}</label>
                                                <p class="desc">
                                                    {{
                                                        $t(
                                                            "agentEditor.imageUpload.storageProviderDesc",
                                                        )
                                                    }}
                                                </p>
                                            </div>
                                            <div
                                                ...
                                                <t-select
                                                    ...
                                                    :placeholder="
                                                        $t(
                                                            'agentEditor.imageUpload.storageProviderPlaceholder',
                                                        )
                                                    "
                                                    clearable>
                                                    <t-option
                                                        ...
                                                        :label="
                                                            $t(
                                                                'agentEditor.imageUpload.storageDefault',
                                                            )
                                                        " />
                                                    <t-option
                                                        ...
                                                        <span class="select-option-with-tag">
                                                            ...
                                                            <t-tag
                                                                ...
                                                                >{{
                                                                    $t(
                                                                        "agentEditor.imageUpload.notConfigured",
                                                                    )
                                                                }}</t-tag
                                                            >
                                                        </span>
                                                ...
                                                <a
                                                    ...
                                                    {{
                                                        $t(
                                                            "agentEditor.imageUpload.goStorageSettings",
                                                        )
                                                    }}
                                                </a>
                                            </div>
                                        </div>
                                        <!-- 音频上传（启用后可选择 ASR 模型与存储） -->
                                        <div class="setting-row" style="margin-top: 12px">
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agentEditor.audioUpload.label")
                                                }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.audioUpload.desc") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-switch
                                                    v-model="
                                                        formData.config.audio_upload_enabled
                                                    " />
                                            </div>
                                        </div>
                                        ...
                                        <!-- ASR 模型（音频上传启用时） -->
                                        <div
                                            v-if="formData.config.audio_upload_enabled"
                                            class="setting-row">
                                            <div class="setting-info">
                                                <label
                                                    >{{ $t("agentEditor.audioUpload.asrModel") }}
                                                    <span class="required">*</span></label
                                                >
                                                <p class="desc">
                                                    {{ $t("agentEditor.audioUpload.asrModelDesc") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <ModelSelector
                                                    model-type="ASR"
                                                    :selected-model-id="
                                                        formData.config.asr_model_id
                                                    "
                                                    :all-models="allModels"
                                                    @update:selected-model-id="
                                                        (val: string) =>
                                                            (formData.config.asr_model_id = val)
                                                    "
                                                    @add-model="handleAddModel('asr')"
                                                    :placeholder="
                                                        $t(
                                                            'agentEditor.audioUpload.asrModelPlaceholder',
                                                        )
                                                    " />
                                            </div>
                                        </div>
                                ...
                                <div
                                    v-show="currentSection === 'conversation' && !isAgentMode"
                                    class="section">
                                    <div class="section-header">
                                    ...
                                    <div class="settings-group">
                                        ...
                                        <div class="setting-row">
                                            <div class="setting-info">
                                                ...
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.multiTurn") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-switch
                                                    v-model="formData.config.multi_turn_enabled" />
                                            </div>
                                        </div>

                                        <!-- 保留轮数 -->
                                        <div
                                            v-if="formData.config.multi_turn_enabled"
                                            class="setting-row">
                                            <div class="setting-info">
                                                <label>{{ $t("agent.editor.historyTurns") }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.historyRounds") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-input-number
                                                    v-model="formData.config.history_turns"
                                                    :min="1"
                                                    :max="20"
                                                    theme="column" />
                                            </div>
                                        ...
                                        <div
                                            v-if="
                                                formData.config.multi_turn_enabled && !isAgentMode
                                            "
                                            class="setting-row">
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agent.editor.enableRewrite")
                                                }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.rewrite") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-switch
                                                    v-model="formData.config.enable_rewrite" />
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            v-if="
                                                formData.config.multi_turn_enabled &&
                                                !isAgentMode &&
                                                formData.config.enable_rewrite
                                            "
                                            class="setting-row setting-row-vertical">
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agent.editor.rewritePromptSystem")
                                                }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.rewriteSystemPrompt") }}
                                                </p>
                                                <div
                                                    class="placeholder-tags"
                                                    v-if="rewriteSystemPlaceholders.length > 0">
                                                    <span class="placeholder-label">{{
                                                        $t("agentEditor.placeholders.available")
                                                    }}</span>
                                                    <t-tooltip
                                            ...
                                            <div
                                                ...
                                                <div class="textarea-with-template">
                                                    <t-textarea
                                                        ...
                                                        v-model="
                                                            formData.config.rewrite_prompt_system
                                                        "
                                                        :placeholder="
                                                            defaultRewritePromptSystem ||
                                                            $t(
                                                                'agent.editor.rewritePromptSystemPlaceholder',
                                                            )
                                                        "
                                                    ...
                                                    <PromptTemplateSelector
                                                        ...
                                                        @reset-default="
                                                            handleRewriteTemplateSelect
                                                        " />
                                                </div>
                                                <Teleport to="body">
                                                    <div
                                                        v-if="
                                                            rewriteSystemPopup.show &&
                                                            filteredRewriteSystemPlaceholders.length >
                                                                0
                                                        "
                                                        class="placeholder-popup-wrapper"
                                                        ...
                                                        <div class="placeholder-popup">
                                                            <div
                                                                v-for="(
                                                                    placeholder, index
                                                                ) in filteredRewriteSystemPlaceholders"
                                                                :key="placeholder.name"
                                                                class="placeholder-item"
                                                                :class="{
                                                                    active:
                                                                        rewriteSystemPopup.selectedIndex ===
                                                                        index,
                                                                }"
                                                                @mousedown.prevent="
                                                                    insertGenericPlaceholder(
                                                                        'rewriteSystem',
                                                                        placeholder.name,
                                                                        true,
                                                                    )
                                        ...
                                        <div
                                            ...
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agent.editor.rewritePromptUser")
                                                }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.rewriteUserPrompt") }}
                                                </p>
                                                <div
                                                    class="placeholder-tags"
                                                    v-if="rewritePlaceholders.length > 0">
                                                    <span class="placeholder-label">{{
                                                        $t("agentEditor.placeholders.available")
                                                    }}</span>
                                                    <t-tooltip
                                            ...
                                            <div
                                                ...
                                                <div class="textarea-with-template">
                                                    <t-textarea
                                                        ...
                                                        v-model="
                                                            formData.config.rewrite_prompt_user
                                                        "
                                                        :placeholder="
                                                            defaultRewritePromptUser ||
                                                            $t(
                                                                'agent.editor.rewritePromptUserPlaceholder',
                                                            )
                                                        "
                                                        :autosize="{ minRows: 4, maxRows: 10 }"
                                                ...
                                                <Teleport to="body">
                                                    <div
                                                        v-if="
                                                            rewriteUserPopup.show &&
                                                            filteredRewriteUserPlaceholders.length >
                                                                0
                                                        "
                                                        class="placeholder-popup-wrapper"
                                                        ...
                                                        <div class="placeholder-popup">
                                                            <div
                                                                v-for="(
                                                                    placeholder, index
                                                                ) in filteredRewriteUserPlaceholders"
                                                                :key="placeholder.name"
                                                                class="placeholder-item"
                                                                :class="{
                                                                    active:
                                                                        rewriteUserPopup.selectedIndex ===
                                                                        index,
                                                                }"
                                                                @mousedown.prevent="
                                                                    insertGenericPlaceholder(
                                ...
                                <!-- 工具配置（仅 Agent 模式） -->
                                <div
                                    v-show="currentSection === 'tools' && isAgentMode"
                                    class="section">
                                    <div class="section-header">
                                    ...
                                    <div class="settings-group">
                                        ...
                                        <div class="setting-row setting-row-vertical">
                                            ...
                                            <div class="setting-control setting-control-full">
                                                <t-checkbox-group
                                                    v-model="formData.config.allowed_tools"
                                                    ...
                                                    <t-checkbox
                                                        ...
                                                        <div class="tool-item-content">
                                                            ...
                                                            <span
                                                                v-if="tool.disabled"
                                                                class="tool-disabled-hint"
                                                                >{{
                                                                    $t(
                                                                        "agentEditor.tools.requiresKb",
                                                                    )
                                                                }}</span
                                                            >
                                                        </div>
                                        ...
                                        <div class="setting-row">
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agent.editor.maxIterations")
                                                }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.maxIterations") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-input-number
                                                    v-model="formData.config.max_iterations"
                                                    :min="1"
                                                    :max="50"
                                                    theme="column" />
                                            </div>
                                            ...
                                            <div class="setting-control">
                                                <t-radio-group v-model="mcpSelectionMode">
                                                    <t-radio-button value="all">{{
                                                        $t("agentEditor.selection.all")
                                                    }}</t-radio-button>
                                                    <t-radio-button value="selected">{{
                                                        $t("agentEditor.selection.selected")
                                                    }}</t-radio-button>
                                                    <t-radio-button value="none">{{
                                                        $t("agentEditor.selection.disabled")
                                                    }}</t-radio-button>
                                                </t-radio-group>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agentEditor.mcp.selectLabel")
                                                }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.mcp.selectDesc") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-select
                                                    ...
                                                    multiple
                                                    :placeholder="
                                                        $t('agentEditor.mcp.selectPlaceholder')
                                                    "
                                                    filterable>
                                                    <t-option
                                ...
                                <div
                                    v-show="currentSection === 'skills' && isAgentMode"
                                    class="section">
                                    <div class="section-header">
                                        <h2>{{ $t("agent.editor.skillsConfig") }}</h2>
                                        <p class="section-description">
                                            {{ $t("agent.editor.skillsConfigDesc") }}
                                        </p>
                                    </div>
                                    ...
                                    <div class="settings-group">
                                        ...
                                        <div class="setting-row">
                                            <div class="setting-info">
                                                ...
                                                <p class="desc">
                                                    {{ $t("agent.editor.skillsSelectionDesc") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-radio-group v-model="skillsSelectionMode">
                                                    <t-radio-button value="all">{{
                                                        $t("agent.editor.skillsAll")
                                                    }}</t-radio-button>
                                                    <t-radio-button value="selected">{{
                                                        $t("agent.editor.skillsSelected")
                                                    }}</t-radio-button>
                                                    <t-radio-button value="none">{{
                                                        $t("agent.editor.skillsNone")
                                                    }}</t-radio-button>
                                                </t-radio-group>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div class="setting-info">
                                                ...
                                                <p class="desc">
                                                    {{ $t("agent.editor.selectSkillsDesc") }}
                                                </p>
                                            </div>
                                            <div class="setting-control setting-control-full">
                                                <t-checkbox-group
                                        ...
                                        <div class="skill-info-box">
                                            ...
                                            <div class="info-content">
                                                <p>
                                                    <strong>{{
                                                        $t("agent.editor.skillsInfoTitle")
                                                    }}</strong>
                                                </p>
                                ...
                                <div v-show="currentSection === 'knowledge'" class="section">
                                    ...
                                    <div class="settings-group">
                                        ...
                                        <div class="setting-row">
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agent.editor.knowledgeBases")
                                                }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.kbScope") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-radio-group v-model="kbSelectionMode">
                                                    <t-radio-button value="all">{{
                                                        $t("agent.editor.allKnowledgeBases")
                                                    }}</t-radio-button>
                                                    <t-radio-button value="selected">{{
                                                        $t("agent.editor.selectedKnowledgeBases")
                                                    }}</t-radio-button>
                                                    <t-radio-button value="none">{{
                                                        $t("agent.editor.noKnowledgeBase")
                                                    }}</t-radio-button>
                                                </t-radio-group>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            v-if="kbSelectionMode === 'selected'"
                                            class="setting-row">
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agent.editor.selectKnowledgeBases")
                                                }}</label>
                                                <p class="desc">
                                                    {{
                                                        $t("agent.editor.selectKnowledgeBasesDesc")
                                                    }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-select
                                                    ...
                                                    :min-collapsed-num="3">
                                                    <t-option-group
                                                        v-if="myKbOptions.length"
                                                        :label="
                                                            $t('agent.editor.myKnowledgeBases')
                                                        ">
                                                        <t-option
                                                            ...
                                                            <div class="kb-option-item">
                                                                ...
                                                                <span class="kb-option-label">{{
                                                                    kb.label
                                                                }}</span>
                                                                <span class="kb-option-count">{{
                                                                    kb.count || 0
                                                                }}</span>
                                                            </div>
                                                        </t-option>
                                                    ...
                                                    <t-option-group
                                                        v-if="sharedKbOptions.length"
                                                        :label="
                                                            $t('agent.editor.sharedKnowledgeBases')
                                                        ">
                                                        <t-option
                                        ...
                                        <div v-if="hasKnowledgeBase" class="setting-row">
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agentEditor.fileTypes.label")
                                                }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.fileTypes.desc") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-select
                                                    ...
                                                    multiple
                                                    :placeholder="
                                                        $t('agentEditor.fileTypes.allTypes')
                                                    "
                                                    :min-collapsed-num="3"
                                                    clearable>
                                                    <t-option
                                        ...
                                        <div v-if="hasKnowledgeBase" class="setting-row">
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agent.editor.retrieveKBOnlyWhenMentioned")
                                                }}</label>
                                                <p class="desc">
                                                    {{
                                                        $t(
                                        ...
                                        <div v-if="needsRerankModel" class="setting-row">
                                            ...
                                            <div class="setting-control">
                                                <ModelSelector
                                                    model-type="Rerank"
                                                    :selected-model-id="
                                                        formData.config.rerank_model_id
                                                    "
                                                    :all-models="allModels"
                                                    @update:selected-model-id="
                                                        (val: string) =>
                                                            (formData.config.rerank_model_id = val)
                                                    "
                                                    @add-model="handleAddModel('rerank')"
                                                    :placeholder="
                                                        $t('agent.editor.rerankModelPlaceholder')
                                                    " />
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            v-if="hasFaqKnowledgeBase"
                                            class="faq-strategy-section">
                                            ...
                                            <div class="setting-row">
                                                <div class="setting-info">
                                                    <label>{{
                                                        $t("agentEditor.faq.enableLabel")
                                                    }}</label>
                                                    <p class="desc">
                                                        {{ $t("agentEditor.faq.enableDesc") }}
                                                    </p>
                                                </div>
                                                <div class="setting-control">
                                                    <t-switch
                                                        v-model="
                                                            formData.config.faq_priority_enabled
                                                        " />
                                                </div>
                                            </div>
                                            ...
                                            <!-- FAQ 直接回答阈值 -->
                                            <div
                                                v-if="formData.config.faq_priority_enabled"
                                                class="setting-row">
                                                <div class="setting-info">
                                                    <label>{{
                                                        $t("agentEditor.faq.thresholdLabel")
                                                    }}</label>
                                                    <p class="desc">
                                                        {{ $t("agentEditor.faq.thresholdDesc") }}
                                                    </p>
                                                </div>
                                                <div class="setting-control">
                                                    <div class="slider-wrapper">
                                                        <t-slider
                                                            ...
                                                            :step="0.05" />
                                                        <span class="slider-value">{{
                                                            formData.config.faq_direct_answer_threshold?.toFixed(
                                                                2,
                                                            )
                                                        }}</span>
                                                    </div>
                                            ...
                                            <div
                                                ...
                                                <div class="setting-info">
                                                    <label>{{
                                                        $t("agentEditor.faq.boostLabel")
                                                    }}</label>
                                                    <p class="desc">
                                                        {{ $t("agentEditor.faq.boostDesc") }}
                                                    </p>
                                                </div>
                                                <div class="setting-control">
                                                    <div class="slider-wrapper">
                                                        <t-slider
                                                            v-model="
                                                                formData.config.faq_score_boost
                                                            "
                                                            :min="1"
                                                            :max="2"
                                                            :step="0.1" />
                                                        <span class="slider-value"
                                                            >{{
                                                                formData.config.faq_score_boost?.toFixed(
                                                                    1,
                                                                )
                                                            }}x</span
                                                        >
                                ...
                                <div v-show="currentSection === 'websearch'" class="section">
                                    <div class="section-header">
                                        ...
                                        <p class="section-description">
                                            {{ $t("agent.editor.webSearchConfigDesc") }}
                                        </p>
                                    </div>
                                    ...
                                    <div class="settings-group">
                                        ...
                                        <div class="setting-row">
                                            <div class="setting-info">
                                                ...
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.webSearch") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-switch
                                                    v-model="formData.config.web_search_enabled" />
                                            </div>
                                        </div>

                                        <!-- 网络搜索最大结果数 -->
                                        <div
                                            v-if="formData.config.web_search_enabled"
                                            class="setting-row">
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agent.editor.webSearchProvider")
                                                }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.webSearchProvider") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-select
                                                    ...
                                                    :placeholder="
                                                        $t(
                                                            'agent.editor.webSearchProviderPlaceholder',
                                                        )
                                                    "
                                                    style="width: 240px">
                                                    <t-option
                                        ...
                                        <div
                                            ...
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agent.editor.webSearchMaxResults")
                                                }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.webSearchMaxResults") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <div class="slider-wrapper">
                                                    <t-slider
                                                        v-model="
                                                            formData.config.web_search_max_results
                                                        "
                                                        :min="1"
                                                        :max="10" />
                                                    <span class="slider-value">{{
                                        ...
                                        <div
                                            ...
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agent.editor.webFetchEnabled")
                                                }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.webFetchEnabled") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-switch
                                                    v-model="formData.config.web_fetch_enabled" />
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            v-if="
                                                formData.config.web_search_enabled &&
                                                formData.config.web_fetch_enabled
                                            "
                                            class="setting-row">
                                            <div class="setting-info">
                                                <label>{{ $t("agent.editor.webFetchTopN") }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.webFetchTopN") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <div class="slider-wrapper">
                                                    <t-slider
                                                        v-model="formData.config.web_fetch_top_n"
                                                        :min="1"
                                                        :max="10" />
                                                    <span class="slider-value">{{
                                                        formData.config.web_fetch_top_n
                                                    }}</span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <!-- 检索策略（仅在有知识库能力时显示） -->
                                <div
                                    v-show="currentSection === 'retrieval' && hasKnowledgeBase"
                                    class="section">
                                    <div class="section-header">
                                        <h2>{{ $t("agent.editor.retrievalStrategy") }}</h2>
                                        <p class="section-description">
                                            {{ $t("agentEditor.desc.retrievalSection") }}
                                        </p>
                                    </div>
                                    ...
                                    <div class="settings-group">
                                        ...
                                        <div v-if="!isAgentMode" class="setting-row">
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agent.editor.enableQueryExpansion")
                                                }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.queryExpansion") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-switch
                                                    v-model="
                                                        formData.config.enable_query_expansion
                                                    " />
                                            </div>
                                        </div>
                                        ...
                                        <div class="setting-row">
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agent.editor.embeddingTopK")
                                                }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.embeddingTopK") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <t-input-number
                                                    v-model="formData.config.embedding_top_k"
                                                    :min="1"
                                                    :max="50"
                                                    theme="column" />
                                            </div>
                                        ...
                                        <div class="setting-row">
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agent.editor.keywordThreshold")
                                                }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.keywordThreshold") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <div class="slider-wrapper">
                                                    <t-slider
                                                        v-model="formData.config.keyword_threshold"
                                                        :min="0"
                                                        :max="1"
                                                        :step="0.01" />
                                                    <span class="slider-value">{{
                                                        formData.config.keyword_threshold?.toFixed(
                                                            2,
                                                        )
                                                    }}</span>
                                                </div>
                                        ...
                                        <div class="setting-row">
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agent.editor.vectorThreshold")
                                                }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.vectorThreshold") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <div class="slider-wrapper">
                                                    <t-slider
                                                        v-model="formData.config.vector_threshold"
                                                        :min="0"
                                                        :max="1"
                                                        :step="0.01" />
                                                    <span class="slider-value">{{
                                                        formData.config.vector_threshold?.toFixed(2)
                                                    }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="setting-row">
                                            <div class="setting-info">
                                                <label>{{
                                                    $t("agent.editor.rerankThreshold")
                                                }}</label>
                                                <p class="desc">
                                                    {{ $t("agentEditor.desc.rerankThreshold") }}
                                                </p>
                                            </div>
                                            <div class="setting-control">
                                                <div class="slider-wrapper">
                                                    <t-slider
                                                        v-model="formData.config.rerank_threshold"
                                                        :min="-10"
                                                        :max="10"
                                                        :step="0.01" />
                                                    <span class="slider-value">{{
                                                        formData.config.rerank_threshold?.toFixed(1)
                                                    }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <template v-if="!isAgentMode">
                                            <div class="setting-row">
                                                <div class="setting-info">
                                                    <label>{{
                                                        $t("agent.editor.fallbackStrategy")
                                                    }}</label>
                                                    <p class="desc">
                                                        {{
                                                            $t("agentEditor.desc.fallbackStrategy")
                                                        }}
                                                    </p>
                                                </div>
                                                <div class="setting-control">
                                                    <t-radio-group
                                                        v-model="formData.config.fallback_strategy">
                                                        <t-radio-button value="fixed">{{
                                                            $t("agentEditor.fallback.fixed")
                                                        }}</t-radio-button>
                                                        <t-radio-button value="model">{{
                                                            $t("agentEditor.fallback.model")
                                                        }}</t-radio-button>
                                                    </t-radio-group>
                                                </div>
                                            </div>
                                            ...
                                            <!-- 固定兜底回复 -->
                                            <div
                                                v-if="formData.config.fallback_strategy === 'fixed'"
                                                class="setting-row setting-row-vertical">
                                                <div class="setting-info">
                                                    <label>{{
                                                        $t("agent.editor.fallbackResponse")
                                                    }}</label>
                                                    <p class="desc">
                                                        {{
                                                            $t("agentEditor.desc.fallbackResponse")
                                                        }}
                                                    </p>
                                                </div>
                                                <div class="setting-control setting-control-full">
                                                    <div class="textarea-with-template">
                                                        <t-textarea
                                                            v-model="
                                                                formData.config.fallback_response
                                                            "
                                                            :placeholder="
                                                                defaultFallbackResponse ||
                                                                $t(
                                                                    'agent.editor.fallbackResponsePlaceholder',
                                                                )
                                                            "
                                                            :autosize="{
                                                                minRows: 2,
                                                        ...
                                                        <PromptTemplateSelector
                                                            ...
                                                            fallbackMode="fixed"
                                                            @select="
                                                                handleFallbackResponseTemplateSelect
                                                            "
                                                            @reset-default="
                                                                handleFallbackResponseTemplateSelect
                                                            " />
                                            ...
                                            <!-- 兜底提示词 -->
                                            <div
                                                v-if="formData.config.fallback_strategy === 'model'"
                                                class="setting-row setting-row-vertical">
                                                <div class="setting-info">
                                                    <label>{{
                                                        $t("agent.editor.fallbackPrompt")
                                                    }}</label>
                                                    <p class="desc">
                                                        {{ $t("agentEditor.desc.fallbackPrompt") }}
                                                    </p>
                                                    <div
                                                        class="placeholder-tags"
                                                        v-if="fallbackPlaceholders.length > 0">
                                                        <span class="placeholder-label">{{
                                                            $t("agentEditor.placeholders.available")
                                                        }}</span>
                                                        <t-tooltip
                                                ...
                                                <div
                                                    ...
                                                    <div class="textarea-with-template">
                                                        <t-textarea
                                                            ...
                                                            v-model="
                                                                formData.config.fallback_prompt
                                                            "
                                                            :placeholder="
                                                                defaultFallbackPrompt ||
                                                                $t(
                                                                    'agent.editor.fallbackPromptPlaceholder',
                                                                )
                                                            "
                                                            :autosize="{ minRows: 4, maxRows: 10 }"
                                                        ...
                                                        <PromptTemplateSelector
                                                            ...
                                                            fallbackMode="model"
                                                            @select="
                                                                handleFallbackPromptTemplateSelect
                                                            "
                                                            @reset-default="
                                                                handleFallbackPromptTemplateSelect
                                                            " />
                                                    ...
                                                    <Teleport to="body">
                                                        <div
                                                            v-if="
                                                                fallbackPromptPopup.show &&
                                                                filteredFallbackPlaceholders.length >
                                                                    0
                                                            "
                                                            class="placeholder-popup-wrapper"
                                                            ...
                                                            <div class="placeholder-popup">
                                                                <div
                                                                    v-for="(
                                                                        placeholder, index
                                                                    ) in filteredFallbackPlaceholders"
                                                                    :key="placeholder.name"
                                                                    class="placeholder-item"
                                                                    :class="{
                                                                        active:
                                                                            fallbackPromptPopup.selectedIndex ===
                                                                            index,
                                                                    }"
                                                                    @mousedown.prevent="
                                                                        insertGenericPlaceholder(
                                ...
                                <div
                                    v-if="
                                        props.mode === 'edit' &&
                                        props.agent?.id &&
                                        !props.agent?.is_builtin
                                    "
                                    v-show="currentSection === 'share'"
                                    class="section">
                                    <AgentShareSettings
                                ...
                                <!-- IM集成（仅编辑模式） -->
                                <div
                                    v-if="props.mode === 'edit' && props.agent?.id"
                                    v-show="currentSection === 'im'"
                                    class="section">
                                    <div class="section-header">
...
// 音频存储 Provider（与图片存储选项相同来源）
const audioStorageOptions = computed(() => {
    const statusMap: Record<string, boolean> = {}
    for (const e of storageEngineStatus.value) {
        statusMap[e.name] = e.available
    }
...
const allTools = computed(() => [
    {
        value: "thinking",
        label: t("agentEditor.tools.thinking"),
        description: t("agentEditor.tools.thinkingDesc"),
        requiresKB: false,
    },
    {
        value: "todo_write",
        label: t("agentEditor.tools.todoWrite"),
        description: t("agentEditor.tools.todoWriteDesc"),
        requiresKB: false,
    },
    {
        value: "grep_chunks",
        label: t("agentEditor.tools.grepChunks"),
        description: t("agentEditor.tools.grepChunksDesc"),
        requiresKB: true,
    },
    {
        value: "knowledge_search",
        label: t("agentEditor.tools.knowledgeSearch"),
        description: t("agentEditor.tools.knowledgeSearchDesc"),
        requiresKB: true,
    },
    {
        value: "list_knowledge_chunks",
        label: t("agentEditor.tools.listChunks"),
        description: t("agentEditor.tools.listChunksDesc"),
        requiresKB: true,
    },
    {
        value: "query_knowledge_graph",
        label: t("agentEditor.tools.queryGraph"),
        description: t("agentEditor.tools.queryGraphDesc"),
        requiresKB: true,
    },
    {
        value: "get_document_info",
        label: t("agentEditor.tools.getDocInfo"),
        description: t("agentEditor.tools.getDocInfoDesc"),
        requiresKB: true,
    },
    {
        value: "database_query",
        label: t("agentEditor.tools.dbQuery"),
        description: t("agentEditor.tools.dbQueryDesc"),
        requiresKB: true,
    },
    {
        value: "data_analysis",
        label: t("agentEditor.tools.dataAnalysis"),
        description: t("agentEditor.tools.dataAnalysisDesc"),
        requiresKB: true,
    },
    {
        value: "data_schema",
        label: t("agentEditor.tools.dataSchema"),
        description: t("agentEditor.tools.dataSchemaDesc"),
        requiresKB: true,
    },
])
...
const availableFileTypes = [
    ...
    {
        value: "txt",
        label: t("agentEditor.fileTypes.textLabel"),
        description: t("agentEditor.fileTypes.text"),
    },
    ...
    {
        value: "jpg",
        label: t("agentEditor.fileTypes.imageLabel"),
        description: t("agentEditor.fileTypes.image"),
    },
]
...
const availablePlaceholders = computed(() => {
    return isAgentMode.value
        ? placeholderData.value.agent_system_prompt
        : placeholderData.value.system_prompt
})
...
const rewriteSystemPopup = ref<PlaceholderPopupState>({
    ...
    timer: null,
    fieldKey: "rewrite_prompt_system",
    placeholders: [],
})
...
const navItems = computed(() => {
    ...
    if (!isAgentMode.value) {
        items.push({
            key: "conversation",
            icon: "chat",
            label: t("agent.editor.conversationSettings"),
        })
    }
    // 共享管理（仅编辑模式且非内置智能体）
...
const agentMode = computed({
    ...
    set: (val: "quick-answer" | "smart-reasoning") => {
        formData.value.config.agent_mode = val
    },
})
    ...
    async (val) => {
        if (val) {
            ...
            if (props.mode === "edit" && props.agent) {
                ...
                if (!agentData.config.supported_file_types)
                    agentData.config.supported_file_types = []

                // 兼容旧数据：如果没有 agent_mode 字段，根据 allowed_tools 推断
                if (!agentData.config.agent_mode) {
                    const isAgent =
                        agentData.config.max_iterations > 1 ||
                        (agentData.config.allowed_tools &&
                            agentData.config.allowed_tools.length > 0)
...
const filteredPlaceholders = computed(() => {
    ...
    return availablePlaceholders.value.filter((p) => p.name.toLowerCase().startsWith(prefix))
})
...
const filteredContextPlaceholders = computed(() => {
    ...
    return contextTemplatePlaceholders.value.filter((p) => p.name.toLowerCase().startsWith(prefix))
})
...
const filteredRewriteSystemPlaceholders = computed(() => {
    ...
    return rewriteSystemPlaceholders.value.filter((p) => p.name.toLowerCase().startsWith(prefix))
})
...
const filteredRewriteUserPlaceholders = computed(() => {
    ...
    return rewritePlaceholders.value.filter((p) => p.name.toLowerCase().startsWith(prefix))
})
...
const filteredFallbackPlaceholders = computed(() => {
    ...
    return fallbackPlaceholders.value.filter((p) => p.name.toLowerCase().startsWith(prefix))
})
...
const calculateCursorPosition = (textarea: HTMLTextAreaElement) => {
    ...
    const top =
        textareaRect.top + paddingTop + currentLine * lineHeight - scrollTop + lineHeight + 4
...
// 通用获取 textarea 元素
const getGenericTextareaElement = (
...
const handleRewriteSystemInput = () => {
    ...
    rewriteSystemPopup.value.timer = setTimeout(() => {
        checkAndShowGenericPlaceholderPopup(
            "rewriteSystem",
            rewriteSystemPopup,
            "rewrite_prompt_system",
            filteredRewriteSystemPlaceholders.value,
        )
    }, 50)
}
...
const handleRewriteUserInput = () => {
    ...
    rewriteUserPopup.value.timer = setTimeout(() => {
        checkAndShowGenericPlaceholderPopup(
            ...
            rewriteUserPopup,
            "rewrite_prompt_user",
            filteredRewriteUserPlaceholders.value,
        )
    }, 50)
}
...
const handleFallbackPromptInput = () => {
    ...
    fallbackPromptPopup.value.timer = setTimeout(() => {
        checkAndShowGenericPlaceholderPopup(
            ...
            fallbackPromptPopup,
            "fallback_prompt",
            filteredFallbackPlaceholders.value,
        )
    }, 50)
}

// 通用插入占位符
const insertGenericPlaceholder = (
    type: "rewriteSystem" | "rewriteUser" | "fallback",
            ...
            textarea.addEventListener(
                ...
                (e: KeyboardEvent) => {
                    if (
                        ...
                        filteredContextPlaceholders.value.length > 0
                    ) {
                        if (e.key === "ArrowDown") {
                            e.preventDefault()
                            e.stopPropagation()
                            if (
                                ...
                                filteredContextPlaceholders.value.length - 1
                            ) {
                                selectedContextPlaceholderIndex.value++
                            } else {
                                selectedContextPlaceholderIndex.value = 0
                            ...
                            e.stopPropagation()
                            const selected =
                                filteredContextPlaceholders.value[
                                    selectedContextPlaceholderIndex.value
                                ]
                            if (selected) {
                ...
                (e: KeyboardEvent) => {
                    if (showPlaceholderPopup.value && filteredPlaceholders.value.length > 0) {
                        if (e.key === "ArrowDown") {
                            ...
                            e.stopPropagation()
                            const selected =
                                filteredPlaceholders.value[selectedPlaceholderIndex.value]
                            if (selected) {
...
const handlePlaceholderClick = (
    type: "system" | "context" | "rewriteSystem" | "rewriteUser" | "fallback",
    placeholderName: string,
) => {
    if (type === "system") {
    ...
    (val) => {
        if (val) {
            nextTick(() => {
                ...
                setupGenericTextareaEventListeners(
                    "rewriteSystem",
                    rewriteSystemPopup,
                    () => filteredRewriteSystemPlaceholders.value,
                )
...
const handleSave = async () => {
    ...
    if (!isBuiltinAgent.value) {
        ...
        if (
            ...
            (!formData.value.config.context_template ||
                !formData.value.config.context_template.trim())
        ) {
    ...
    if (formData.value.config.suggested_prompts) {
        formData.value.config.suggested_prompts = formData.value.config.suggested_prompts.filter(
            (p: string) => p.trim() !== "",
        )
    }
