...
export function useStream() {
    ...
    const startStream = async (params: {
        ...
        try {
            ...
            // Include attachments if provided (array of { name, size, type, url, id })
            if (params.attachments !== undefined && params.attachments.length > 0) {
                postBody.attachments = params.attachments
            }
            ...
            await fetchEventSource(url, {
                ...
                headers: {
                    ...
                    "Accept-Language":
                        i18n.global.locale?.value || localStorage.getItem("locale") || "zh-CN",
