export default {
    ...
    knowledgeEditor: {
        ...
        asr: {
            title: "音频处理配置",
            description:
                "配置语音识别功能，启用后支持上传音频文件（mp3、wav、m4a、flac、ogg）并自动转录为文本",
            label: "启用语音识别",
    ...
    agentEditor: {
        ...
        im: {
            title: "IM 集成",
            description:
                "将智能体接入即时通讯平台，支持企业微信、飞书、Slack、Telegram、钉钉和 Mattermost",
            wecom: "企业微信",
            feishu: "飞书",
            slack: "Slack",
            telegram: "Telegram",
        ...
        audioUpload: {
            label: "音频上传",
            desc: "启用后用户可在对话中上传音频文件进行语音识别或转写（mp3、wav、m4a、flac、ogg 等）",
            asrModel: "ASR 模型",
            asrModelDesc: "用于将音频转成文本的语音识别模型（如 OpenAI Whisper）",
