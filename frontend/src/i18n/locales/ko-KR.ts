export default {
    ...
    settings: {
        ...
        enableMemoryDesc:
            "활성화하면 시스템이 대화 기록을 저장하고 향후 대화에서 관련 내용을 자동으로 회상하여 더 개인화된 답변을 제공합니다.",
        memoryRequiresNeo4j:
            "기억 기능은 Neo4j 그래프 데이터베이스가 필요합니다. 이 기능을 활성화하기 전에 Neo4j를 구성하고 활성화해 주세요 (NEO4J_ENABLE=true 설정).",
    ...
    webSearchSettings: {
        ...
        noProviders:
            '검색 엔진 프로바이더가 설정되지 않았습니다. "프로바이더 추가"를 클릭하여 시작하세요.',
        ...
        defaultProviderDescription:
            "자체 프로바이더를 지정하지 않은 에이전트의 기본 검색 프로바이더를 선택합니다",
    ...
    agent: {
        ...
        stepsCompletedWithDuration:
            "<strong>{steps}</strong>개 단계 완료, 소요 시간 <strong>{duration}</strong>",
        title: "에이전트",
    ...
    knowledgeEditor: {
        ...
        chunking: {
            ...
            parentChildDescription:
                "2단계 부모-자식 청킹 전략을 활성화합니다. 큰 부모 청크는 컨텍스트를 제공하고, 작은 자식 청크는 벡터 매칭에 사용됩니다.",
        ...
        asr: {
            title: "오디오 처리 설정",
            description:
                "음성 인식 기능을 설정하여 오디오 파일(mp3, wav, m4a, flac, ogg)을 업로드하고 자동으로 텍스트로 전사합니다",
            label: "음성 인식 활성화",
    ...
    agentSettings: {
        ...
        globalConfigNotice:
            "이것은 전역 기본 설정입니다. 새 에이전트를 만들면 이 설정을 상속합니다. 에이전트 목록에서 각 에이전트를 개별적으로 구성할 수도 있습니다.",
        ...
        systemPrompt: {
            ...
            tabHintDetail:
                "통합 시스템 프롬프트 (비워두면 시스템 기본값 사용, {'{{'}web_search_status{'}}'} 자리 표시자로 웹 검색 동작을 동적 제어)",
    ...
    conversationSettings: {
        ...
        contextTemplate: {
            ...
            descWithDefault:
                "일반 모드에서 검색 결과를 기반으로 답변을 생성하는 Prompt 템플릿 (비워두면 시스템 기본값 사용)",
    ...
    modelSettings: {
        ...
        builtinModels: {
            title: "기본 제공 모델",
            description:
                "기본 제공 모델은 모든 테넌트에게 표시됩니다. 민감한 정보는 숨겨지며, 편집하거나 삭제할 수 없습니다.",
    ...
    kbSettings: {
        storage: {
            title: "스토리지 엔진",
            description:
                "파일 스토리지 엔진을 선택합니다. 문서 업로드 및 문서 내 이미지 저장 방식에 영향을 미칩니다. 파라미터는 전역 설정에서 구성합니다.",
            loading: "로딩 중...",
            engineLabel: "스토리지 엔진",
            engineDesc:
                "이 지식베이스에 사용할 스토리지 엔진을 선택하세요. 전역 설정에서 해당 엔진이 구성되어 있어야 합니다.",
            selectPlaceholder: "스토리지 엔진 선택",
            notConfigured: "미구성",
            unavailable: "사용 불가",
            lockedHint:
                "지식베이스에 파일이 있어 스토리지 엔진을 변경할 수 없습니다. 변경하려면 모든 파일을 먼저 삭제하세요.",
            changeWarning:
                "스토리지 엔진을 변경하면 새로 업로드된 파일에만 영향을 미칩니다. 기존 파일은 여전히 원래 스토리지 엔진에서 읽히지만, 일부 이전 파일의 경로를 자동으로 인식할 수 없어 접근이 불가능할 수 있습니다.",
    ...
    agentEditor: {
        ...
        im: {
            title: "IM 통합",
            description:
                "에이전트를 Feishu, Slack, Telegram, DingTalk, Mattermost 등 인스턴트 메시징 플랫폼에 연결",
            feishu: "Feishu",
            slack: "Slack",
            telegram: "Telegram",
            dingtalk: "DingTalk",
        ...
        imageUpload: {
            ...
            sectionDesc:
                "이미지 업로드 및 비전 언어 모델을 설정하여 대화에서 멀티모달 기능을 활성화합니다",
            label: "이미지 업로드",
        ...
        audioUpload: {
            label: "오디오 업로드",
            desc: "사용자가 대화에서 음성 인식 또는 전사를 위해 오디오 파일을 업로드할 수 있습니다 (mp3, wav, m4a, flac, ogg 등)",
            asrModel: "ASR 모델",
            asrModelDesc: "오디오를 텍스트로 변환하는 음성 인식 모델 (예: OpenAI Whisper)",
        ...
        faq: {
            title: "FAQ 우선 전략",
            tooltip:
                "지식베이스에 FAQ(질문-답변 쌍)가 포함된 경우, 이 전략을 활성화하면 FAQ 답변이 일반 문서보다 우선됩니다",
