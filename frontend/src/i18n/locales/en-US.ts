...
\
            ...
            parentChildDescription:
                "Enable two-level parent-child chunking strategy. Large parent chunks provide context while small child chunks are used for vector matching.",
        ...
        asr: {
            ...
            description:
                "Configure speech recognition to upload audio files (mp3, wav, m4a, flac, ogg) and automatically transcribe to text",
    ...
    agentEditor: {
        ...
        im: {
            ...
            description:
                "Connect agent to instant messaging platforms like WeCom, Feishu, Slack, Telegram, DingTalk, and Mattermost",
            feishu: "Feishu",
            slack: "Slack",
            telegram: "Telegram",
            dingtalk: "DingTalk",
        ...
        audioUpload: {
            label: "Audio Upload",
            desc: "Enable users to upload audio files in chat for speech-to-text (mp3, wav, m4a, flac, ogg).",
            asrModel: "ASR Model",
            asrModelDesc:
                "Automatic Speech Recognition model for transcribing audio (e.g., OpenAI Whisper).",
